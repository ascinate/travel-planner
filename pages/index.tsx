                                ...
                                <div className={isActive ? 'show-my-div' : 'mains-d-hidden'}>
                                   <div className='mains-forms014 bg-white'>
                                        ...
                                        <div className='inside-scrolls-div grid grid-cols-2 gap-5  items-center'>
                                         <div className='scrollbard-main grid grid-cols-2 gap-5 col-span-2'>
                                          {/* --- Inputs (all preserved) --- */}
                                            ...
                                            <div className="d-hidden col-span-2">
                                              <div className="mt-4 col-span-4 xl:col-span-2 off-scrolls grid grid-cols-2 gap-x-5 items-end">
                                                  ...
                                                  {/* Time Preferences */}
                                                  <div className="grid grid-cols-1 xl:grid-cols-1 gap-x-5">
                                                    <div className='crm-groups col-span-4 xl:col-span-1'>
                                                  ...
                                                  <div className="grid grid-cols-1 xl:grid-cols-1 gap-x-5">
                                                    <div className='crm-groups xl:col-span-1'>
                                                  ...
                                                  <div className="grid grid-cols-1 xl:grid-cols-2 col-span-2 gap-x-5">
                                                      <div className="crm-groups">
                                     ...
                                     <div className="sm-div-btn ml:auto">
                                        ...
                                        {remaining !== null && (
                                          ...
                                          <span> Free Plan: </span>  {remaining} itinerary free no sign-up required.
                                          </p>
                                        )}
                                        </div>
                      ...
                      <>
                        ...
                        <div className='float-left  w-full'>
                          <div className='container sub-pages01 position-relative'>
                            ...
                            <h1 className='md:flex items-center sub-tr mb-4'> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className='mr-2' width="32" height="32" fill="rgba(234,113,46,1)"><path d="M12 20.8995L16.9497 15.9497C19.6834 13.2161 19.6834 8.78392 16.9497 6.05025C14.2161 3.31658 9.78392 3.31658 7.05025 6.05025C4.31658 8.78392 4.31658 13.2161 7.05025 15.9497L12 20.8995ZM12 23.7279L5.63604 17.364C2.12132 13.8492 2.12132 8.15076 5.63604 4.63604C9.15076 1.12132 14.8492 1.12132 18.364 4.63604C21.8787 8.15076 21.8787 13.8492 18.364 17.364L12 23.7279ZM12 13C13.1046 13 14 12.1046 14 11C14 9.89543 13.1046 9 12 9C10.8954 9 10 9.89543 10 11C10 12.1046 10.8954 13 12 13ZM12 15C9.79086 15 8 13.2091 8 11C8 8.79086 9.79086 7 12 7C14.2091 7 16 8.79086 16 11C16 13.2091 14.2091 15 12 15Z"></path></svg>  Heres what NicheTrips Creates for You </h1>
