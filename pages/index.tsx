                                   ...
                                   <div className='mains-forms014 bg-white'>
                                    <div className='inside-scrolls-div grid grid-cols-2 gap-5  items-center'>
                                      {/* --- Inputs (all preserved) --- */}
                                        ...
                                        <div className="sm-div-btn col-span-4 xl:col-span-2">
                                            <button
                                    ...
                                    <button onClick={() => setOpen(!open)}
                                                    className="advance-btn flex items-center col-span-4 md:ml-auto md:justify-end xl:col-span-1"
                                                  >
                                        ...
                                        <div className="crm-groups col-span-4 xl:col-span-1 mt-5 md:ml-auto">
                                        {remaining !== null && (
                                          <p className="text-sm plans015 text-gray-600 mt-0 md:text-right">
                                          <span> Free Plan: </span>  {remaining} Litenraries free - no sign-up required.
                                          </p>
                                        )}
                                        </div>
